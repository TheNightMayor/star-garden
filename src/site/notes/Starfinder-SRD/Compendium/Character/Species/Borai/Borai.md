...
>[!infobox|txt-s n-th]
>![Images/Aliens/Species/Borai/Borai.png\|Borai.png](/img/user/Images/Aliens/Species/Borai/Borai.png)
> # stats
>
>|||
> |----:|:----|
> |**hp**|6|
> |**mods**|+2 Con, +2 Cha, -2 Wis|
> |**size**|Medium|
> |**type**|undead|
> |**Source**|`=this.source`|
>
...
Borais’ not-quite-dead bodies still have some of their old racial traits. At character creation, a borai selects one of the following races as his original living form and gains the racial trait indicated in parenthesis for the selected race: [[Starfinder-SRD/Compendium/Character/Species/Android/Android\|Android]] (upgrade slot), [[Starfinder-SRD/Compendium/Character/Species/Human/Human\|Human]] (skilled), [[Starfinder-SRD/Compendium/Character/Species/Kasatha/Kasatha\|Kasatha]] (four-armed), [[Starfinder-SRD/Compendium/Character/Species/Lashunta/Lashunta\|Lashunta]] (limited telepathy), [[Starfinder-SRD/Compendium/Character/Species/Shirren/Shirren\|Shirren]] (blindsense), [[Starfinder-SRD/Compendium/Character/Species/Vesk/Vesk\|Vesk]] (natural weapons), or [[Starfinder-SRD/Compendium/Character/Species/Ysoki/Ysoki\|Ysoki]] (cheek pouches). A GM can, at her discretion, allow a borai to choose another humanoid race, along with an appropriate racial trait. Additionally, when a borai attempts to disguise himself as a member of his selected race, the DC of his Disguise check is not modified as a result of disguising himself as a different creature type.
...
**Average Height** (height:: See Borai entry)
**Average Weight** (weight:: See Borai entry)
**Age of Maturity** (maturity:: —)
**Maximum Age** (age:: See Borai entry)
