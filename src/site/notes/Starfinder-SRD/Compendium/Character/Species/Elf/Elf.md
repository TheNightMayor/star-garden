---
{"dg-publish":true,"dg-path":"Rules/Character/Species/Elf/Elf.md","permalink":"/rules/character/species/elf/elf/","dg-note-properties":{"abilitymodifiers":"+2 Dex, +2 Int, -2 Con","blurb":"[Elf.png](/img/user/Images/Aliens/Species/Elf/Elf.png)","cssclasses":null,"date created":"Tuesday, August 22nd 2023, 4:01:13 pm","date modified":"Wednesday, August 21st 2024, 7:56:14 pm","hitpoints":4,"section":"legacy","size":"Medium","sizeandtype":"Elves are Medium humanoids with the elf subtype.","tags":[],"type":"humanoid (elf)","aliases":["Elves","elf’s","elves’","Elf"]}}
---


>[!infobox|txt-s n-th]
>![Images/Aliens/Species/Elf/Elf.png\|Elf.png](/img/user/Images/Aliens/Species/Elf/Elf.png)
> # stats
>
>|||
> |----:|:----|
...
Elves receive a +2 racial bonus to caster level checks to overcome spell resistance. In addition, elves receive a +2 racial bonus to [[Starfinder-SRD/Rules/Skills/Mysticism\|Mysticism]] skill checks.

## Keen Senses

Elves receive a +2 racial bonus to [[Starfinder-SRD/Rules/Skills/Perception\|Perception]] skill checks.

## Low-light Vision

Elves can see in dim light as if it were normal light. See [[Starfinder-SRD/Rules/Combat Mechanics/Awareness Senses Vision  Light\|vision and light]]
...
Some elves are born with [[Starfinder-SRD/Rules/Special Abilities/Darkvision (Ex or Su)\|darkvision]] with a range of 60 feet. When these elves are in no light or dim light and they are exposed to bright light, they are dazzled for 1 round.

This replaces low-light vision.

## Elven Skeptic

Elves were betrayed during the Gap and can be untrusting of others. These elves train to see through deceptions, and gain a +2 racial bonus to [[Starfinder-SRD/Rules/Skills/Sense Motive\|Sense Motive]] checks and saving throws against illusion spells. Once per day, they can roll a [[Starfinder-SRD/Rules/Skills/Sense Motive\|Sense Motive]] check twice and use the better result.

This replaces elven immunities.

## Forlorn Connection

Despite being called Forlorn, those elves who live among other species are often quite sociable. These elves gain a +2 racial bonus to [[Starfinder-SRD/Rules/Skills/Diplomacy\|Diplomacy]] checks and can cast [[Starfinder-SRD/Compendium/Spells/Spells Level 1/Comprehend Languages\|Comprehend Languages]] once per day. At 10th level, they can also cast [[Starfinder-SRD/Compendium/Spells/Spells Level 3/Tongues\|Tongues]] once per day.
...
Many elves enjoy spending time in unspoiled wilderness. They gain a +2 racial bonus to [[Starfinder-SRD/Rules/Skills/Survival\|Survival]] checks.
