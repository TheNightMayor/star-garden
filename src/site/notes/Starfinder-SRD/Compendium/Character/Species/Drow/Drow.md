...
>[!infobox|txt-s n-th]
>![Images/Aliens/Species/Drow/Drow.png\|Drow.png](/img/user/Images/Aliens/Species/Drow/Drow.png)
> # stats
>
>|||
> |----:|:----|
> |**hp**|4|
> |**mods**|+2 Dex, +2 Cha, -2 Con|
> |**size**|Medium|
> |**type**|humanoid (elf)|
> |**Source**|`=this.source`|
>
...
Drow have [[Starfinder-SRD/Rules/Special Abilities/Darkvision (Ex or Su)\|Darkvision (Ex or Su)]] with a range of 60 feet.
...
At will—_[[Starfinder-SRD/Compendium/Spells/Spells Level 0/Dancing Lights\|Dancing Lights]]_, _[[Starfinder-SRD/Compendium/Spells/Spells Level 0/Detect Magic\|Detect Magic]]_

In addition, drow count as having the [[Starfinder-SRD/Compendium/Character/Feats/General Feats/Minor Psychic Power\|Minor Psychic Power]] feat for the purpose of meeting prerequisites, and if a drow takes the [[Starfinder-SRD/Compendium/Character/Feats/General Feats/Psychic Power\|Psychic Power]] feat, she can add the drow noble’s limning light supernatural ability to the list of spell-like abilities available to her.

**Limning Light:** As a standard action, a drow noble can cause all creatures and objects in a 5-foot-radius burst to shed a pale glow. Creatures outlined by the limning light take a –20 penalty to [[Starfinder-SRD/Rules/Skills/Stealth\|Stealth]] checks and don’t benefit from the [[Cover  Concealmen\|concealment]] usually provided by darkness. If an affected creature is benefiting from an effect such as [[Starfinder-SRD/Compendium/Spells/Spells Level 2/Invisibility\|Invisibility]], all others within line of sight of it become aware of its location. This effect lasts for a number of minutes equal to the drow level. This ability has a range of 100 feet.

## Keen Senses

Drow receive a +2 racial bonus to their [[Starfinder-SRD/Rules/Skills/Perception\|Perception]] checks.

## Light Blindness

A drow exposed to bright light is [[Starfinder-SRD/Rules/Combat Mechanics/Conditions/Conditions#Blinded\|blinded]] for 1 round, and dazzled as long as she remains in areas of bright light.
