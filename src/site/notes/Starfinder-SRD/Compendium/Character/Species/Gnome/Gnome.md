...
>[!infobox|txt-s n-th]
>![Images/Aliens/Species/Gnome/Gnome-Blurb.png\|Gnome-Blurb.png](/img/user/Images/Aliens/Species/Gnome/Gnome-Blurb.png)
> # stats
>
>|||
> |----:|:----|
> |**hp**|4|
> |**mods**|+2 Con, +2 Cha, -2 Str (Feychild) or +2 Con, +2 Int, -2 Str (Bleachling)|
> |**size**|Small|
> |**type**|humanoid (gnome)|
> |**Source**|`=this.source`|
>
...
**Average Height** (height:: 3 to 3-1/2 ft.)
**Average Weight** (weight:: 30–50 lbs.)
**Age of Maturity** (maturity:: 40 years)
**Maximum Age** (age:: 200+3d% years)
