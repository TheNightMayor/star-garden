...
>[!infobox|txt-s n-th]
>![Images/Aliens/Species/Vesk/Vesk.png\|Vesk.png](/img/user/Images/Aliens/Species/Vesk/Vesk.png)
> # stats
>
>|||
> |----:|:----|
> |**hp**|6|
> |**mods**|+2 Str, +2 Con, -2 Int|
> |**size**|Medium|
> |**type**|humanoid (vesk)|
> |**Source**|`=this.source`|
>
...
> |Age of Maturity| P16Y |
> |Maximum Age| 70+1d20 years|
>
>![Vesk-Card-Stats.jpg\|ws-med](/img/user/Images/Aliens/Species/Vesk/Vesk-Card-Stats.jpg)
>![Vesk-Card-Portrait.jpg\|ws-med](/img/user/Images/Aliens/Species/Vesk/Vesk-Card-Portrait.jpg)
# Vesk
...
Vesk can see in dim light as if it were normal light. For more details, see [[Starfinder-SRD/Rules/Special Abilities/Low-Light Vision\|Low-Light Vision]].

## Natural Weapons

Vesk can attack with a special unarmed strike that deals lethal damage, doesn’t count as archaic, and threatens squares. Vesk gain a special version of the [[Starfinder-SRD/Compendium/Character/Feats/Combat Feats/Weapon Specialization Combat\|Weapon Specialization Combat]] feat with this unarmed strike at 3rd level, allowing them to add 1–1/2 × their character level to their damage rolls for this unarmed strike (instead of just adding their character level, as usual).
...
Vesk respect honor, strength, and self-mastery. Though their relations with the races of the Pact Worlds remain strained due to the only barely averted war, they admire [[Starfinder-SRD/Compendium/Species copy/Android/Android\|androids]]’ dispassionate consistency, [[Starfinder-SRD/Compendium/Species copy/Kasatha/Kasatha\|kasathas]]’ sense of honor, and the strength of [[Starfinder-SRD/Compendium/Species copy/Lashunta/Lashunta\|lashuntas]] in battle. However, they find [[Starfinder-SRD/Compendium/Character/Species/Ysoki/Ysoki\|Ysoki]] weak and frivolous, and [[Starfinder-SRD/Compendium/Species copy/Human/Human\|humans]] quick to break their agreements. [[Starfinder-SRD/Compendium/Species copy/Shirren/Shirren\|shirrens]] perplex vesk with their refusal to parlay their strengths, including their instinctive coordination in battle and willingness to die for their comrades, into an empire.

## Adventurers

Vesk adventuring with races from other systems fall into two categories. The first are mercenaries or glory-seekers looking for a chance to engage in honorable combat and build up their prestige. The second are nonwarrior vesk who have rejected their home society for its obsession with combat and have chosen instead to seek opportunities among more open-minded races. Warrior vesk most often fit the [[Starfinder-SRD/Compendium/Character/Classes/Soldier/Soldier\|soldier]] class, though a growing number have become intrigued by the path of the [[Starfinder-SRD/Compendium/Character/Classes/Solarian/Solarian\|Solarian]]. Noncombatant vesk often lean toward becoming [[Starfinder-SRD/Compendium/Character/Classes/Mystic/Mystic\|mystics]], though some overcome the traditional vesk culture’s dismissal of education to become [[Starfinder-SRD/Compendium/Character/Classes/Mechanic/Mechanic\|Mechanics]] or even [[Starfinder-SRD/Compendium/Character/Classes/Technomancer/Technomancer\|technomancers]].
...
Many vesk take pride in being as physically fit as possible. They gain a +2 racial bonus to [[Starfinder-SRD/Rules/Skills/Athletics\|Athletics]] and [[Starfinder-SRD/Rules/Skills/Acrobatics\|Acrobatics]] checks.
This replaces fearless.

## Cave Senses

Vesk who grew up underground in twisted caverns have more sensitive hearing. They have low-light vision and gain blindsight (sound) 60 feet, but they take a –4 penalty to sight-based [[Starfinder-SRD/Rules/Skills/Perception\|Perception]] checks beyond 60 feet and take a –2 penalty on ranged attack rolls against targets beyond 60 feet in bright light.
...
Some vesk have particularly elaborate bone spikes on their heads, giving them an especially fearsome appearance. These vesk gain a +2 racial bonus to [[Starfinder-SRD/Rules/Skills/Intimidate\|Intimidate]] checks.
This replaces armor savant.

## Observant

Some vesk learn to watch their environment and other creatures around them for signs of danger. Vesk with this racial trait select either [[Starfinder-SRD/Rules/Skills/Perception\|Perception]] or [[Starfinder-SRD/Rules/Skills/Sense Motive\|Sense Motive]]. They gain a +3 racial bonus to checks with the chosen skill. Once this choice is made, it cannot be changed.
