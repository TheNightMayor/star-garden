---
{"dg-publish":true,"permalink":"/starfinder-srd/compendium/character/species/android/android/","dg-note-properties":{"abilitymodifiers":"+2 Dex, +2 Int, -2 Cha","aliases":["android's","androids","Androids","androids'"],"blurb":"[Android-Blurb.png](/img/user/Images/Aliens/Species/Android/Android-Blurb.png)","cssclasses":null,"date created":"Tuesday, August 22nd 2023, 4:01:13 pm","date modified":"Tuesday, December 10th 2024, 2:24:39 am","hitpoints":4,"portrait":"Android-Card-Portrait.jpg","section":"core","size":"Medium","sizeandtype":"Androids are Medium humanoids with the android subtype.","source":null,"stats":"Android-Card-Stats.jpg","tags":[],"type":"humanoid (android)"}}
---


>[!infobox|txt-s n-th right]
>![Images/Aliens/Species/Android/Android-Blurb.png\|Android-Blurb.png](/img/user/Images/Aliens/Species/Android/Android-Blurb.png)
> # stats
>
>|||
> |----:|:----|
> |**hp**|4|
> |**mods**|+2 Dex, +2 Int, -2 Cha|
> |**size**|Medium|
...
>![Android-Card-Stats.jpg\|ws-med](/img/user/Images/Aliens/Species/Android/Android-Card-Stats.jpg)
>![Android-Card-Portrait.jpg\|ws-med](/img/user/Images/Aliens/Species/Android/Android-Card-Portrait.jpg)
>
# Android

Complex technological creations crafted to resemble [[Starfinder-SRD/Compendium/Character/Species/Human/Human\|humans]], androids were originally a servitor race, but they have since broken free to form their own society. Unlike ordinary robots or ship AIs, androids do not simply respond according to their programming; rather, they have independent consciousnesses and are animated by souls—a distinction crucial to their generally accepted status as people rather than property.
...
Androids have [[Starfinder-SRD/Rules/Special Abilities/Darkvision (Ex or Su)\|Darkvision (Ex or Su)]] with a range of 60 feet and [[Starfinder-SRD/Rules/Special Abilities/Low-Light Vision\|Low-Light Vision]]

### Flat Affect

Androids find emotions confusing and keep them bottled up. They take a –2 penalty to [[Starfinder-SRD/Rules/Skills/Sense Motive\|Sense Motive]] checks, but the DCs of [[Starfinder-SRD/Rules/Skills/Sense Motive\|Sense Motive]] checks attempted against them increase by 2.
...
Often cautious around strangers, androids have the most strained relationship with [[Starfinder-SRD/Compendium/Character/Species/Human/Human\|humanity]], which built them in its image and remains their most frequent oppressor. They feel closest to [[Starfinder-SRD/Compendium/Character/Species/Shirren/Shirren\|Shirren]], who also know what it is to be enslaved and misunderstood, and respect [[Starfinder-SRD/Compendium/Character/Species/Kasatha/Kasatha\|Kasathas]]’ self-sufficiency. They generally dislike [[Starfinder-SRD/Compendium/Character/Species/Vesk/Vesk\|Vesk]], whom they see as slavers, and only grudgingly tolerate [[Starfinder-SRD/Compendium/Character/Species/Ysoki/Ysoki\|Ysoki]]’s antics.

### Adventurers

Androids adventure for many reasons: to earn a living, trace the origins of their race, or rescue androids and other creatures from servitude. Their quick thinking under fire makes them natural [[Starfinder-SRD/Compendium/Character/Classes/Operative/Operative\|operatives]] and [[Starfinder-SRD/Compendium/Character/Classes/Soldier/Soldier\|soldiers]], while their affinity for machines makes them excellent [[Starfinder-SRD/Compendium/Character/Classes/Mechanic/Mechanic\|mechanics]] and [[Starfinder-SRD/Compendium/Character/Classes/Technomancer/Technomancer\|technomancers]].
...
Although most androids stand out as artificial beings, some have intricate personality matrices and physical alterations that downplay their constructed nature. Androids who have this alternate racial trait don’t take any penalty to [[Starfinder-SRD/Rules/Skills/Disguise\|Disguise]] checks to change their appearance to a creature of a different race or type if they are disguising themselves as a human. If the android also has the xenometric android alternate racial trait (see page 17), this benefit instead applies to [[Starfinder-SRD/Rules/Skills/Disguise\|Disguise]] checks to change appearance to that of the race chosen along with the xenometric android alternate racial trait.
...
The artificial brain an android possesses can allow better compatibility with infospheres and direct downloads of information. An android with this trait has a built-in [[Starfinder-SRD/Compendium/Items/Technological Items/Comm Unit/Comm Unit\|comm unit]] that can be accessed without needing to use their hands. Once per day, whenever the android takes a 10-minute rest to regain Stamina Points, they can choose one Intelligence-, Wisdom-, or Charisma-based skill. The chosen skill becomes a class skill for them, and they gain [[Starfinder-SRD/Compendium/Character/Feats/General Feats/Skill Focus\|Skill Focus]] as a bonus feat with that skill. This decision lasts until the next time the android uses this trait.

This replaces exceptional vision.

### Multilingual

New languages are easy for some androids to learn. An android with this racial trait knows four additional languages at 1st level. In addition, whenever such an android invests a skill rank into [[Starfinder-SRD/Rules/Skills/Culture\|Culture]], they learn two new languages instead of one.

This replaces upgrade slot.

### Nanite Upgrade

Specialized nanites maintain an android body, but they can be upgraded to perform additional tasks. Androids who have this racial trait gain [[Starfinder-SRD/Compendium/Character/Feats/General Feats/Nanite Integration\|Nanite Integration]] as a bonus feat, ignoring the feat’s prerequisites.
This replaces upgrade slot.
...
_Starfinder Core Rulebook_ options are [[Starfinder-SRD/Compendium/Character/Species/Dwarf/Dwarf\|Dwarf]](darkvision, slow but steady), [[Starfinder-SRD/Compendium/Character/Species/Elf/Elf\|Elf]] (elven immunities, low-light vision), [[Starfinder-SRD/Compendium/Character/Species/Gnome/Gnome\|Gnome]](gnome magic, low-light vision), [[Starfinder-SRD/Compendium/Character/Species/Half-Elf/Half-Elf\|Half-Elf]] (adaptability, low-light vision), [[Starfinder-SRD/Compendium/Character/Species/Half-Orc/Half-Orc\|Half-Orc]] (darkvision, intimidating, self-sufficient), [[Starfinder-SRD/Compendium/Character/Species/Halfling/Halfling\|Halfling]] (keen senses, sneaky, sure-footed), [[Starfinder-SRD/Compendium/Character/Species/Kasatha/Kasatha\|Kasatha]] (four-armed, natural grace), [[Starfinder-SRD/Compendium/Character/Species/Lashunta/Lashunta\|Lashunta]] (lashunta magic, limited telepathy), [[Starfinder-SRD/Compendium/Character/Species/Shirren/Shirren\|Shirren]] (blindsense, limited telepathy), [[Starfinder-SRD/Compendium/Character/Species/Vesk/Vesk\|Vesk]] (low-light vision, natural weapons), and [[Starfinder-SRD/Compendium/Character/Species/Ysoki/Ysoki\|Ysoki]](cheek pouches, darkvision).

_Starfinder Alien Archive_ options are [[Starfinder-SRD/Compendium/Character/Species/Dragonkin/Dragonkin\|Starfinder-SRD/Compendium/Character/Species/Dragonkin/Dragonkin]] (draconic immunities, flight), [[Starfinder-SRD/Compendium/Character/Species/Formian/Formian\|Formian]] (limited telepathy, natural weapons), [[Starfinder-SRD/Compendium/Character/Species/Haan/Haan\|Starfinder-SRD/Compendium/Character/Species/Haan/Haan]] (firespray, slow fall), [[Starfinder-SRD/Compendium/Character/Species/Kalo/Kalo\|Kalo]] (kalo movement, kalo vision), [[Starfinder-SRD/Compendium/Character/Species/Maraquoi/Maraquoi\|Maraquoi]] (blindsense, prehensile tail), [[Starfinder-SRD/Compendium/Character/Species/Nuar/Nuar\|Nuar]] (natural weapons, swift), [[Starfinder-SRD/Compendium/Character/Species/Verthani/Verthani\|Verthani]] (skill focus, skin mimic), and [[Starfinder-SRD/Compendium/Character/Species/Wrikreechee/Wrikreechee\|Starfinder-SRD/Compendium/Character/Species/Wrikreechee/Wrikreechee]] (snag, wrikreechee movement).

_Starfinder Alien Archive 2_ options are [[Starfinder-SRD/Compendium/Character/Species/Hobgoblin/Hobgoblin\|Hobgoblin]] (fearsome, sneaky), [[Starfinder-SRD/Compendium/Character/Species/Orc/Orc\|Orc]] (fierce survivalist, orc ferocity), [[Starfinder-SRD/Compendium/Character/Species/Pahtra/Pahtra\|Pahtra]] (nimble, talented), and [[Starfinder-SRD/Compendium/Character/Species/Vlaka/Vlaka\|Vlaka]] (cold resistance, perceptive).

The _Starfinder Pact Worlds_ option is the [[Starfinder-SRD/Compendium/Character/Species/Strix/Strix\|Strix]] (nightborn, strix mobility).
