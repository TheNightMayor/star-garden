...
**Activity**: You spend the day analyzing a physical sample of a creature or material. The sample must have at least light bulk, and you must have access to a [[Starfinder-SRD/Compendium/Vehicles/Starships/Starship Expansion Bays/Science Lab\|Science Lab]] or similar facilities for the whole day.  
  
**Results**: You learn information about the creature or material as if you had taken 20 on a skill check to [[Starfinder-SRD/Compendium/Spells/Spells Level 1/Identify\|Identify]] it, using the appropriate skill for its creature type (Core Rulebook 133) if it’s a creature, Engineering if it’s a technological or hybrid item, or Mysticism if it’s a magic or hybrid item. You must be trained in the appropriate skill or you gain no benefit. The GM might rule that certain creatures or materials are too rare or unusual to be identified this way.  
